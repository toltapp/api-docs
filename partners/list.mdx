---
title: "List Partners"
api: "GET https://dev-api-v.tolt.io/v1/partners"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/partners?program_id=prg_YRsbPDAKhWfdqJbFACheh' \
...
```bash cURL - Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/partners?program_id=prg_YRsbPDAKhWfdqJbFACheh&expand[]=group&expand[]=program' \
-H 'Authorization: Bearer <API_KEY>' \
-H 'Content-Type: application/json' \
-d ''
```
