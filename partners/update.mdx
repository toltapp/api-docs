...
api: "PUT https://dev-api-v.tolt.io/v1/partners/:id"
...
<ParamField body="status" type="string - optional">
  Partner's status. Valid values are: 'active', 'inactive'
</ParamField>
...
```bash cURL
curl -X PATCH 'https://dev-api-v.tolt.io/v1/partners/part_s7mbzRGn46BhVgNFHD6fDgXW' \
