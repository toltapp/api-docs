...
api: "GET https://dev-api-v.tolt.io/v1/transactions"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/transactions?program_id=prg_YRsbPDAKhWfdqJbFACheh' \
-H 'Authorization: Bearer <API_KEY>'
```

```bash With Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/transactions?program_id=prg_YRsbPDAKhWfdqJbFACheh&expand[]=customer&expand[]=program&expand[]=partner' \
-H 'Authorization: Bearer <API_KEY>'
```
