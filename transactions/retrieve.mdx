...
api: "GET https://dev-api-v.tolt.io/v1/transactions/:id"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/transactions/txn_eK9bzRGn46BhVgNFHD6fDgXW' \
-H 'Authorization: Bearer <API_KEY>'
```

```bash With Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/transactions/txn_eK9bzRGn46BhVgNFHD6fDgXW?expand[]=customer&expand[]=program&expand[]=partner' \
-H 'Authorization: Bearer <API_KEY>'
```
