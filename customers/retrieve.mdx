...
api: "GET https://dev-api-v.tolt.io/v1/customers/:id"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/customers/cust_dK9bzRGn46BhVgNFHD6fDgXW' \
...
curl -X GET 'https://dev-api-v.tolt.io/v1/customers/cust_dK9bzRGn46BhVgNFHD6fDgXW?expand[]=partner&expand[]=program&include[]=stats' \
-H 'Authorization: Bearer <API_KEY>' \
-H 'Content-Type: application/json' \
-d ''
```
