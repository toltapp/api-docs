...
api: "GET https://dev-api-v.tolt.io/v1/customers"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/customers?program_id=prg_YRsbPDAKhWfdqJbFACheh' \
...
```bash cURL - Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/customers?program_id=prg_YRsbPDAKhWfdqJbFACheh&expand[]=partner&expand[]=program' \
-H 'Authorization: Bearer <API_KEY>' \
-H 'Content-Type: application/json' \
-d ''
```
