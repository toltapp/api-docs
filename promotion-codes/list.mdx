...
api: "GET https://dev-api-v.tolt.io/v1/promotion-codes"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/promotion-codes' \
-H 'Authorization: Bearer <API_KEY>'
```

```bash With Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/promotion-codes?expand[]=partner&expand[]=program' \
-H 'Authorization: Bearer <API_KEY>'
```
