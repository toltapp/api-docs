...
api: "GET https://dev-api-v.tolt.io/v1/promotion-codes/:id"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/promotion-codes/prc_dK9bzRGn46BhVgNFHD6fDgXW' \
-H 'Authorization: Bearer <API_KEY>'
```

```bash With Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/promotion-codes/prc_dK9bzRGn46BhVgNFHD6fDgXW?expand[]=partner&expand[]=program' \
-H 'Authorization: Bearer <API_KEY>'
```
