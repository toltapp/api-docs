...
api: "GET https://dev-api-v.tolt.io/v1/commissions"
...
```bash cURL
curl -X GET 'https://dev-api-v.tolt.io/v1/commissions?program_id=prg_YRsbPDAKhWfdqJbFACheh' \
-H 'Authorization: Bearer <API_KEY>'
```

```bash With Expand
curl -X GET 'https://dev-api-v.tolt.io/v1/commissions?program_id=prg_YRsbPDAKhWfdqJbFACheh&expand[]=partner&expand[]=program&expand[]=customer&expand[]=transaction' \
-H 'Authorization: Bearer <API_KEY>'
```
